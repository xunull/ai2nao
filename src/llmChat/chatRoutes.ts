...
export type LlmChatChatRouteDeps = {
...
export function registerLlmChatChatRoutes(app: Hono, deps?: LlmChatChatRouteDeps): void {
  ...
  app.post("/api/llm-chat", async (c) => {
    ...
    try {
      uiMessages = validateLlmChatUiMessages(rawBody.messages);
    } catch (e) {
      const msg = e instanceof Error ? e.message : String(e);
      llmChatLog.warn(reqId, "invalid UI messages", msg);
      return jsonErr(e instanceof LlmChatMessageCodecError ? 400 : 500, msg);
    }
