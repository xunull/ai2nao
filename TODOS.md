...
下面 69 条按性质分组，组内不排先后（另有 2 条待归档、5 条本轮销账，列在末尾）。
算式：上一版 65 条活跃 − 5 条销账 + 2 条新增 = 62；2026-08-26 +2、2026-08-27 +1、2026-09-01 +3、2026-09-02 +1 = 69。上一版头部写的 67 含了那 2 条待归档。**加粗**的是建议优先看的。
